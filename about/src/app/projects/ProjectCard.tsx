...
export const ProjectCard = ({ project }: Props) => {
	const meow = project.name;
	return (
		<div className='card bg-base-100 w-96 rounded-1 border-1 hover:scale-103 transition-all'>
			<figure>
				<img
					className='border-b-1' //replace with next Image
